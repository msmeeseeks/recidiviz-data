...
from recidiviz.ingest.us_pa_greene.us_pa_greene_person import UsPaGreenePerson
from recidiviz.ingest.us_pa_greene.us_pa_greene_record import UsPaGreeneOffense
from recidiviz.ingest.us_pa_greene.us_pa_greene_record import UsPaGreeneRecord


class UsPaGreeneScraper(GenericScraper):
    ...
    def populate_extra_person_params(self, content, params, person):
        ...
        """
        person.us_pa_greene_person_id = person.person_id
        person.us_pa_greene_inmate_id = params['inmate_id']
    ...
    def get_offenses(self, content, params):
        ...
        for row in body:
            ...
            # date, But PA Greene leaves this field blank.
