...
"""Scraper implementation for us_ky_daviess."""
...
class UsKyDaviessScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_daviess."""
    def __init__(self):
        super(UsKyDaviessScraper, self).__init__('us_ky_daviess')
    ...
    def get_jailtracker_index(self):
        ...
        """
        return 'DAVIES_COUNTY_KY'

    def get_enum_overrides(self) -> EnumOverrides:
        overrides_builder = super(UsKyDaviessScraper,
