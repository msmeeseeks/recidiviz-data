...
"""Scraper implementation for us_ky_marion."""
from recidiviz.ingest.scrape.vendors.jailtracker.jailtracker_scraper import \
    JailTrackerScraper


class UsKyMarionScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_marion."""
    def __init__(self):
        super(UsKyMarionScraper, self).__init__('us_ky_marion')
