...
"""Scraper implementation for us_ky_bullitt."""
...
class UsKyBullittScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_bullitt."""
    def __init__(self):
        super(UsKyBullittScraper, self).__init__('us_ky_bullitt')
    ...
    def get_jailtracker_index(self):
        ...
        """
        return 'BULLITT_COUNTY_KY'

    def get_enum_overrides(self) -> EnumOverrides:
        overrides_builder = super(UsKyBullittScraper,
