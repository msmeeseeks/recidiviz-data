...
"""Scraper implementation for us_ky_clay."""
...
class UsKyClayScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_clay."""
    def __init__(self):
        super(UsKyClayScraper, self).__init__('us_ky_clay')
    ...
    def get_jailtracker_index(self):
        ...
        """
        return 'CLAY_COUNTY_KY'

    def get_enum_overrides(self) -> EnumOverrides:
        overrides_builder = super(UsKyClayScraper,
