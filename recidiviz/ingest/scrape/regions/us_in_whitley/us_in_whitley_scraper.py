...
"""Scraper implementation for us_in_whitley."""
from recidiviz.ingest.scrape.vendors.jailtracker.jailtracker_scraper import \
    JailTrackerScraper


class UsInWhitleyScraper(JailTrackerScraper):
    """Scraper implementation for us_in_whitley."""
    def __init__(self):
        super(UsInWhitleyScraper, self).__init__('us_in_whitley')
