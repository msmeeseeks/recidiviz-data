...
"""Scraper implementation for us_ky_ballard."""
...
class UsKyBallardScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_ballard."""
    def __init__(self):
        super(UsKyBallardScraper, self).__init__('us_ky_ballard')
    ...
    def get_jailtracker_index(self):
        ...
        """
        return 'BALLARD_COUNTY_KY'

    def get_enum_overrides(self) -> EnumOverrides:
        overrides_builder = super(UsKyBallardScraper,
