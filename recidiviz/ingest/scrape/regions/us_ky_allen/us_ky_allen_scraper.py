...
"""Scraper implementation for us_ky_allen."""
...
class UsKyAllenScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_allen."""

    def __init__(self):
        super(UsKyAllenScraper, self).__init__('us_ky_allen')
    ...
    def get_jailtracker_index(self):
        ...
        """
        return 'ALLEN_COUNTY_KY'

    def get_enum_overrides(self) -> EnumOverrides:
        overrides_builder = super(UsKyAllenScraper,
