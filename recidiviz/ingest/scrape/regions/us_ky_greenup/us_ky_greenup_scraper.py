...
"""Scraper implementation for us_ky_greenup."""
from recidiviz.ingest.scrape.vendors.jailtracker.jailtracker_scraper import \
    JailTrackerScraper


class UsKyGreenupScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_greenup."""
    def __init__(self):
        super(UsKyGreenupScraper, self).__init__('us_ky_greenup')
