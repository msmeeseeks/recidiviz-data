...
"""Scraper implementation for us_ky_boyle."""
...
class UsKyBoyleScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_boyle."""
    def __init__(self):
        super(UsKyBoyleScraper, self).__init__('us_ky_boyle')
    ...
    def get_jailtracker_index(self):
        ...
        """
        return 'BOYLE_COUNTY_KY'

    def get_enum_overrides(self) -> EnumOverrides:
        overrides_builder = super(UsKyBoyleScraper,
                                  self).get_enum_overrides().to_builder()
        overrides_builder.ignore('BONDED', BondType)
        overrides_builder.ignore('10', BondType)
