...
"""Scraper implementation for us_ky_barren."""
from recidiviz.ingest.scrape.vendors.jailtracker.jailtracker_scraper import \
    JailTrackerScraper


class UsKyBarrenScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_barren."""
    def __init__(self):
        super(UsKyBarrenScraper, self).__init__('us_ky_barren')
