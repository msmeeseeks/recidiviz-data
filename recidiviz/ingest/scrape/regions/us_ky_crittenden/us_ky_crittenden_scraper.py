...
"""Scraper implementation for us_ky_crittenden."""
from recidiviz.ingest.scrape.vendors.jailtracker.jailtracker_scraper import \
    JailTrackerScraper


class UsKyCrittendenScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_crittenden."""
    def __init__(self):
        super(UsKyCrittendenScraper, self).__init__('us_ky_crittenden')
