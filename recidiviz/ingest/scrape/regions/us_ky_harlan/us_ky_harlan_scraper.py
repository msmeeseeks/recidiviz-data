...
"""Scraper implementation for us_ky_harlan."""
from recidiviz.ingest.scrape.vendors.jailtracker.jailtracker_scraper import \
    JailTrackerScraper


class UsKyHarlanScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_harlan."""
    def __init__(self):
        super(UsKyHarlanScraper, self).__init__('us_ky_harlan')
