...
"""Scraper implementation for us_ky_bell."""
...
class UsKyBellScraper(JailTrackerScraper):
    """Scraper implementation for us_ky_bell."""
    def __init__(self):
        super(UsKyBellScraper, self).__init__('us_ky_bell')
    ...
    def get_jailtracker_index(self):
        ...
        """
        return 'BELL_COUNTY_BELL'

    def get_enum_overrides(self) -> EnumOverrides:
        overrides_builder = super(UsKyBellScraper,
