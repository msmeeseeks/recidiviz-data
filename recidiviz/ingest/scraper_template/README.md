...
data, and returns it as a result.  Documentation for all of the fields are found [here](https://github.com/Recidiviz/recidiviz-data/tree/master/recidiviz/ingest/models/README.md)
