...
[IngestInfo](https://github.com/Recidiviz/recidiviz-data/tree/master/recidiviz/ingest/models/README.md) object as a parameter, populates it with
data, and returns it as a result.

The [IngestInfo](https://github.com/Recidiviz/recidiviz-data/tree/master/recidiviz/ingest/models/README.md) object contains classes that represent
