...
from recidiviz.ingest.us_nc_buncombe.us_nc_buncombe_scraper import UsNcBuncombeScraper
    ...
    def test_populate_data(self):
        ...
        booking.create_charge(
            ...
            case_number='17CRS093084').create_bond(
                ...
                bond_type='SECURED ')
        booking.create_charge(
            name='MAINTN VEH/DWELL/PLACE CS (F)',
            status='PRE-TRIAL',
            case_number='18CRS000669').create_bond(
                amount='10,000.00',
                bond_type='SECURED ')
        booking.create_charge(
        ...
        booking.create_charge(
            name='PWISD COCAINE',
            status='PRE-TRIAL',
            case_number='18CR 089384').create_bond(
                amount='0.00',
                bond_type='INCLUDED W OTHER ')
        booking.create_charge(
            name='POSSESS DRUG PARAPHERNALIA',
            status='PRE-TRIAL',
            case_number='18CR 089385').create_bond(
                amount='0.00',
                bond_type='INCLUDED W OTHER ')
