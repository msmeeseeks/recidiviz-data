...
"""Scraper tests for us_ky_bullitt."""
import unittest
from lxml import html

from recidiviz.ingest import constants
from recidiviz.ingest.models.ingest_info import IngestInfo
from recidiviz.ingest.us_ky_bullitt.us_ky_bullitt_scraper import UsKyBullittScraper
from recidiviz.tests.utils.base_scraper_test import BaseScraperTest


class TestUsKyBullittScraper(BaseScraperTest, unittest.TestCase):

    def _init_scraper_and_yaml(self):
        # The scraper to be tested. Required.
        self.scraper = UsKyBullittScraper()
