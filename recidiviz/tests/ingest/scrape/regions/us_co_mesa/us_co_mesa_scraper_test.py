...
from recidiviz.ingest.models.ingest_info import IngestInfo, Person, Booking, \
    Charge, Bond
from recidiviz.ingest.scrape.regions.us_co_mesa.us_co_mesa_scraper import \
    UsCoMesaScraper
                ...
                Booking(
                    ...
                    charges=[
                        Charge(
                            ...
                            name="ASSAULT - 2ND DEG - ON A POLICE OFFICER / "
                                 "FIRE FIGHTER",
                            ...
                            name="CRIMINAL MISCHIEF $300 OR MORE, LESS THAN "
                                 "$750",
                            ...
                            name="OBSTRUCTING PEACE OFFICER, FIREFIGHTER, ER "
                                 "MEDICAL SRVC PROVIDER, RESCUE SPC, VOLUNTEER",
                            statute="18-8-104(4)",
                            charge_class="M",
                            level="2",
                            bond=Bond(
                ...
                Booking(
                    ...
                    charges=[
                        Charge(
                            ...
                            name="MARIJUANA - OPEN CONTAINER/USE OR CONSUME IN "
                                 "MOTOR VEHICLE",
                            statute="42-4-1305.5",
                            charge_class="TI",
                            level="A",
                            ...
                            name="2ND DEGREE CRIMINAL TRESPASS ENCLOSED/FENCED "
                                 "AREA",
                            ...
                            name="DIST/MAN/POSS W/INTENT TO DIST > 4G OF SCH "
                                 "III/IV",
                            statute="18-18-405",
                            charge_class="F",
                            level="3",
                            ...
                            name="DROVE (MOTOR/OFF-HIGHWAY) VEHICLE WHEN "
                                 "LICENSE UNDER RESTRAINT (REVOKED)",
