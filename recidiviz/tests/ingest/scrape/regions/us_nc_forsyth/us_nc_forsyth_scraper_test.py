...
"""Scraper tests for us_nc_forsyth."""
import unittest
from lxml import html

from recidiviz.ingest.scrape.regions.us_nc_forsyth.us_nc_forsyth_scraper \
    import UsNcForsythScraper
...
class TestUsNcForsythScraper(SuperionScraperTest, unittest.TestCase):
    def _get_scraper(self):
        return UsNcForsythScraper()
