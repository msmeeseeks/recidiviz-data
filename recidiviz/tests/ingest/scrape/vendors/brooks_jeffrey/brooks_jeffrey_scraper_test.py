...
_PERSON_PAGE_DIV_HTML = html.fromstring(
    fixtures.as_string('vendors/brooks_jeffrey', 'person_page_div.html'))
...
class BrooksJeffreyScraperTest(BaseScraperTest):
    ...
    def test_populate_data_div_format(self):
        expected_info = IngestInfo()
        ...
        self.validate_and_return_populate_data(_PERSON_PAGE_DIV_HTML,
                                               expected_info)
